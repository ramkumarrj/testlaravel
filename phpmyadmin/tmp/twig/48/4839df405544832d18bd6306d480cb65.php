...
/* table/maintenance/optimize.twig */
class __TwigTemplate_eaec743c1263440bcdfb1b6975d3b346 extends Template
{
    private $source;
    private $macros = [];
  ...
  ";
      ...
      <ul class=\"list-group list-group-flush\">
        ";
            ...
            ";
                // line 16
                if ((twig_lower_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "operation", [], "any", false, false, false, 16)) != "optimize")) {
                    // line 17
            ...
            ";
                ...
                // line 21
                if ((twig_lower_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "type", [], "any", false, false, false, 21)) == "error")) {
                    // line 22
                    echo "bg-danger";
...
$context["row"], "type", [], "any", false, false, false, 25)) == "info") || (twig_lower_filter($this->env, twig_get_attribute($this->env, $this->source, $context["row"], "type", [], "any", false, false, false, 25)) == "note"))) {
                    // line 26
                    echo "bg-info";
                } else {
                    // line 28
...
";
    ...
    {
        return "table/maintenance/optimize.twig";
    }
    ...
    {
        return new Source("", "table/maintenance/optimize.twig", "/var/www/html/phpmyadmin/templates/table/maintenance/optimize.twig");
    }
}
